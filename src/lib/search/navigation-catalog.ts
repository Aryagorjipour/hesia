...
export const NAVIGATION_ITEMS: CommandItem[] = [
  ...
  {
    id: "page-settings-sync-send",
    type: "page",
    label: "Send sync",
    description: "Transfer data to another device",
    href: "/settings/data/sync/send",
    keywords: ["p2p", "transfer", "qr"],
  },
  {
    id: "page-settings-sync-receive",
    type: "page",
    label: "Receive sync",
    description: "Import data from another device",
    href: "/settings/data/sync/receive",
    keywords: ["p2p", "import", "qr"],
  },
];